...
// Design-system button (Tailwind tokens): shadcn surfaces use the default
// variants; the board uses the `app`/`appPrimary` variants below.
...
// App-native button variants: `app` is the neutral bordered button, `appPrimary`
// the filled primary (the former `.btn` / `.btn.primary` design in Tailwind).
