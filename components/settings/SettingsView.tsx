...
// Settings page (appearance, profile, sources, bands, stage limits, API tokens).
// Server actions are passed in from the page (the @/app path isn't aliased); the
// signup allowlist lives on /members.
